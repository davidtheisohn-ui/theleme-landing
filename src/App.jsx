...
export default function App(){
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="sticky top-0 z-50 bg-white/70 backdrop-blur border-b border-black/5">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm text-neutral-700">
            ...
            <a href="#process" className="hover:text-black">Parcours</a>
      ...
      {/* HERO */}
      <section id="hero" className="reveal" className="relative overflow-hidden">
...
{/* VALEURS */}
      <section id="valeurs" className="reveal" className="py-16">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">C’est votre style. On l’a juste bien rangé.</h2>
          <div className="grid md:grid-cols-4 gap-6 mt-8">
            {VALS.map((v,i)=>(
              <div key={i} className="bubble card-shadow p-6 relative overflow-hidden">
      ...
      {/* PORTFOLIO */}
      <section id="portfolio" className="reveal" className="py-16">
        <div className="mx-auto max-w-7xl px-4">
...
const VALS = [
  { icon:'/images/v1.svg', title:'Transformez votre espace, sans effort', text:'Nous repensons votre intérieur pour qu’il soit à la fois beau, fonctionnel et parfaitement adapté à votre mode de vie.' },
  { icon:'/images/v2.svg', title:'Pensé pour vous, pas (que) pour Instagram', text:'Vos contraintes deviennent des solutions. Vos goûts, notre point de départ. Fonctionnel. Élégant. Cohérent.' },
  { icon:'/images/v3.svg', title:'Voir le résultat avant de bouger un meuble', text:'Des rendus réalistes pour décider en toute confiance. On remplace le doute par un “wow”.' },
  { icon:'/images/v4.svg', title:'Avancer à votre rythme', text:'Un process fluide, sans rendez‑vous inutiles ni devis flous. On s’occupe du reste.' }
]
