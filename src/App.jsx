...
export default function App(){
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CONFIGURATEUR */}
      <section id="configurateur" className="relative border-t border-black/5">
        <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      {/* VALEURS */}
      <section id="valeurs" className="py-16">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-8">
            {VALS.map((v,i)=>(
              <div key={i} className="rounded-3xl border border-black/5 card-shadow p-6">
                <img src={v.icon} alt="" className="w-14 h-14 rounded-2xl mb-4"/>
