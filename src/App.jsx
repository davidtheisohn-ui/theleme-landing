...
<section id="valeurs" className="reveal py-16">
  <div className="mx-auto max-w-7xl px-4">
    <h2 className="text-center text-3xl md:text-5xl font-semibold tracking-tight mb-10">
      <span className="block">C’est votre style.</span>
      <span className="block">On l’a juste bien rangé.</span>
    </h2>
    <div className="grid md:grid-cols-4 gap-6 items-stretch">
      <div className="relative rounded-3xl overflow-hidden ring-1 ring-black/5 flex flex-col" style={{background:'linear-gradient(180deg,#FAD7D7 0%,#FFDCDC 100%)'}}>
        <div className="px-6 pt-8 pb-24 relative z-10 text-neutral-900">
          <div className="text-lg font-extrabold leading-8">1. Transformez votre espace,<br/>sans effort</div>
          <p className="mt-5 text-[15px] leading-6 text-neutral-800">
            Nous repensons votre intérieur pour qu’il soit à la fois beau,
            fonctionnel et parfaitement adapté à votre mode de vie.
          </p>
          <p className="mt-4 font-semibold">Vous choisissez, on sublime.</p>
        </div>
        <div aria-hidden className="absolute inset-x-0 bottom-0 h-48">
          <img src="/images/hero-room.png" alt="" className="w-full h-full object-cover"/>
        </div>
      </div>

      <div className="relative rounded-3xl overflow-hidden ring-1 ring-black/5 flex flex-col" style={{background:'linear-gradient(180deg,#D4E6FF 0%,#E7F1FF 100%)'}}>
        <div className="px-6 pt-8 pb-24 relative z-10 text-neutral-900">
          <div className="text-lg font-extrabold leading-8">2. Pensé pour vous, pas (que)<br/>pour Instagram</div>
          <p className="mt-5 text-[15px] leading-6 text-neutral-800">
            Vos contraintes deviennent des solutions. Vos goûts, notre point de départ.
          </p>
          <p className="mt-4 font-semibold">Fonctionnel. Élégant. Cohérent.</p>
        </div>
        <div aria-hidden className="absolute inset-x-0 bottom-0 h-48 bg-[#1d4ed8]/5">
          <img src="/images/v2.svg" alt="" className="w-full h-full object-cover"/>
        </div>
      </div>

      <div className="relative rounded-3xl overflow-hidden ring-1 ring-black/5 flex flex-col" style={{background:'linear-gradient(180deg,#F4FF9E 0%,#FFF7B8 100%)'}}>
        <div className="px-6 pt-8 pb-24 relative z-10 text-neutral-900">
          <div className="text-lg font-extrabold leading-8">3. Voir le résultat avant de<br/>bouger un meuble</div>
          <p className="mt-5 text-[15px] leading-6 text-neutral-800">
            Des rendus réalistes pour décider en toute confiance.
          </p>
          <p className="mt-4 font-semibold">On remplace le doute par un “wow”.</p>
        </div>
        <div aria-hidden className="absolute inset-x-0 bottom-0 h-48">
          <img src="/images/step-approve.png" alt="" className="w-full h-full object-cover"/>
        </div>
      </div>

      <div className="relative rounded-3xl overflow-hidden ring-1 ring-black/5 flex flex-col" style={{background:'linear-gradient(180deg,#E7DBFF 0%,#EFE8FF 100%)'}}>
        <div className="px-6 pt-8 pb-24 relative z-10 text-neutral-900">
          <div className="text-lg font-extrabold leading-8">4. Avancez à votre rythme</div>
          <p className="mt-5 text-[15px] leading-6 text-neutral-800">
            Un process fluide, sans RDV inutiles ni devis flous.
          </p>
          <p className="mt-4 font-semibold">Vous avancez à votre rythme — nous, on s’occupe du reste.</p>
        </div>
        <div aria-hidden className="absolute inset-x-0 bottom-0 h-48">
          <img src="/images/step-delivery.png" alt="" className="w-full h-full object-cover"/>
        </div>
      </div>
    </div>
  </div>
